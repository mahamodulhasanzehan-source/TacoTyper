export const WORDLE_WORDS = [
  "apple", "brave", "crane", "drive", "eagle", "flame", "grape", "heart", "image", "juice",
  "knife", "lemon", "mango", "night", "ocean", "peach", "queen", "river", "snake", "train",
  "uncle", "voice", "water", "xenon", "yacht", "zebra", "alien", "baker", "candy", "dance",
  "earth", "fairy", "ghost", "honey", "igloo", "joker", "koala", "laser", "magic", "ninja",
  "oasis", "panda", "quilt", "robot", "sugar", "tiger", "umbra", "virus", "witch", "yummy",
  "zesty", "about", "above", "abuse", "actor", "acute", "admit", "adopt", "adult", "after",
  ...
  "refer", "right", "rival", "river", "robin", "robot", "rough", "round", "route", "royal",
  "rural", "scale", "scene", "scope", "score", "sense", "serve", "seven", "shall", "shape",
  "share", "sharp", "sheet", "shift", "shirt", "shock", "shoot", "short", "shown", "sight",
  ...
  "theft", "their", "theme", "there", "these", "thick", "thing", "think", "third", "thirty",
  "this", "those", "three", "threw", "throw", "tight", "times", "tired", "title", "today",
  ...
  "video", "virus", "visit", "vital", "voice", "watch", "water", "wheel", "where", "which",
